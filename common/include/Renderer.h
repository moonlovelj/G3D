...
namespace g3dcommon
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void RenderTriangleMesh(std::vector<RenderVertex> &vertices,
                                        size_t vertexCount,
        ...
        */
        virtual void SetShadeModel(EShadeModel sModel)
        { shadeModel = sModel; }

        /**
        * Returns shade model of the renderer.
        */
        virtual EShadeModel GetShadeModel() const
        { return shadeModel; }
