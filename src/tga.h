...
int TGAReadColorMap __P((TGA * tga, tbyte * *cmap, tuint32
                            flags));

size_t TGAReadScanlines __P((TGA * tga, tbyte * buf, size_t
                                sln, size_t
                                n,
                                    tuint32
                                flags));
...
int TGAWriteImageId __P((TGA * tga,
                            const tbyte *id));

int TGAWriteColorMap __P((TGA * tga, tbyte * cmap, tuint32
                             flags));

size_t TGAWriteScanlines __P((TGA * tga, tbyte * buf, size_t
                                 sln, size_t
                                 n,
                                     tuint32
                                 flags));
...
char *TGAStrError __P((tuint8
                          code));

tlong __TGASeek __P((TGA * tga, tlong
                        off, int
                        whence));

void __TGAbgr2rgb __P((tbyte * data, size_t
                          size, size_t
                          bytes));
